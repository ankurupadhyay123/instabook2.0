            ...
            , HttpServletResponse response, @RequestParam("file") MultipartFile file, HttpServletRequest request)
    {
        ...
        if (!file.isEmpty()) {
            try {
                ...
                File serverFile = new File("/home/ankur/intellijProjects/link-sharing/src/main/webapp/resources/assets/" +randomnumber+ file.getOriginalFilename());
                BufferedOutputStream stream = new BufferedOutputStream(
                        new FileOutputStream(serverFile));
                stream.write(bytes);
                stream.close();
                createDocumentResource.setFilepath("/home/ankur/intellijProjects/link-sharing/src/main/webapp/resources/assets/" +randomnumber+ file.getOriginalFilename());
