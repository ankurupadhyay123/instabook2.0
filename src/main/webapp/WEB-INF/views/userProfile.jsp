...
<body onload="disablesubmit()" class="body" style="background:url('${pageContext.request.contextPath}/resources/backgroundimages/mybag.jpg');height:100vh;background-position: center;
