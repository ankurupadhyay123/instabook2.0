...
<main>
    ...
    <section id="resetpassword" class="content content--related">
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33" style="padding-top: 40px;">
                    <form class="login100-form validate-form flex-sb flex-w" action="/updatepassword" id="updatePasswordForm" method="post">
                        <span class="login100-form-title p-b-53" style="padding-bottom: 30px;">Password Reset</span>
                        <div class="p-t-31 p-b-9">
                            <span class="txt1">Email *</span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Email is required">
                            <input class="input100" type="text" placeholder="Enter Your Email To Reset Your Password "  id="EmailToReset" name="email" style="height:50px" required>
                            <span class="focus-input100"></span>
                        </div>

                        <div class="p-t-31 p-b-9">
                            <span class="txt1">Enter Verification Code</span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate="Verification Code is required">
                            <input class="input100" type="text" placeholder="Enter Verification Code"  id="verificationcode" name="verificationcode" style="height:50px" required>
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Email is required">
                            <input class="input100" type="password" placeholder="Enter New Password"  id="pass" name="password" style="height:50px" required>
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Email is required">
                            <input class="input100" type="password" placeholder="Enter Confirm Password"  id="confirmpass" name="confirmpassword" style="height:50px" required>
                            <span class="focus-input100"></span>
                        </div>
                        <div class="container-login100-form-btn m-t-17" style="height:50px; margin-top: 30px;">
                            <button class="login100-form-btn" type="submit" id="updatePassword">Update Password</button>
                        </div>
                    </form>
                </div>
            </div>
