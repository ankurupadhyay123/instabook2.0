    ...
    <div class="content content--fixed">
        <header class="codrops-header">
            <div class="codrops-links">
                <a class="codrops-icon codrops-icon--drop" href="https://tympanus.net/codrops/?p=31190" title="Want to know more about instabook?"><svg class="icon icon--drop"><use xlink:href="#icon-drop"></use></svg></a>
            </div>
        </header>
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33" style="padding-top: 40px;">
                    <form class="login100-form validate-form flex-sb flex-w" enctype="multipart/form-data" action="/registrationprocess" method="post">
                        <span class="login100-form-title p-b-53" style="padding-bottom: 30px;">Sign Up With</span>
                        ...
                        <div style="text-align: center; width: 100%; padding-top: 20px">
                            <span class="txt1">Or Register Manually</span>
                        </div>

                        <div class="p-t-31 p-b-9" style="height: 64px;">
                            <span class="txt1" >FirstName</span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate = "FirstName is required">
                            <input class="input100" type="text" name="firstname" style="height:50px">
                            <span class="focus-input100"></span>
                        </div>

                        <div class="p-t-31 p-b-9" style="height: 64px;">
                            <span class="txt1">LastName</span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate = "LastName is required">
                            <input class="input100" type="text" name="lastname" style="height:50px">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Email is required">
                            <input class="input100" type="email" name="email" style="height:50px">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Username is required">
                            <input class="input100" type="text" name="username" style="height:50px">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Password is required">
                            <input class="input100" type="password" name="password" style="height:50px">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Password is required">
                            <input class="input100" type="password" id="confirm_password" name="pass" style="height:50px">
                            <span class="focus-input100"></span>
                        </div>

                        <div class="p-t-13 p-b-9" style="margin-top: 18px">
                            <span class="txt1">Profile Photo</span>
                        </div>
                        <div class="wrap-input100 validate-input" style="height:50px">
                            <div class="file-upload">
                                <div class="file-select" style="height:50px; border-radius: 10px">
                                    <div class="file-select-button" id="fileName" style="height:50px; font-family: Montserrat-Medium; padding-top:03px">Choose File</div>
                                    <div class="file-select-name" id="noFile" style="font-family: Montserrat-Medium">No file chosen...</div>
                                    <input type="file" name="chooseFile" id="chooseFile">
                                </div>
                            </div>
                        </div>
                        <div class="container-login100-form-btn m-t-17" style="height:50px; margin-top: 30px; margin-bottom: 20px">
...
<script th:src="@{/js/scrollMonitor.js}"></script>
<script th:src="@{/js/demo2.js}"></script>
...
<script th:src="@{/js/countdowntime.js}"></script>
